...
<html>
    ...
    <body>
        ...
        <a href="score.php" class="list-group-item">
        <h4 class="list-group-item-heading">
            Test Score
        </h4>
        </a>            
        ...
        <div class="search">
             <form action="revenue.php" method="post" id="my_form">
        <!-- county select -->
        ...
        <div class="btn-group">
        <button  class="btn btn-default" value="Total_Revenue" name="query">Total Revenue</button>
        <button  class="btn btn-default" value="Total_Local_Revenue" name="query">Total Local Revenue</button>
        <button  class="btn btn-default" value="Total_State_Revenue" name="query">Total State Revenue</button>   
        <button  class="btn btn-default" value="Total_Federal_Revenue" name="query">Total Federal Revenue</button> 
        </div>
        </form>
        ...
        <div class="result">
            ...
            define(DB_TABLENAME, 'revenue_query');
            
            $dbcolarray = array('Year_ID', 'District_Name', 'Total_Revenue', 'Total_Local_Revenue', 'Total_State_Revenue', 'Total_Federal_Revenue');
            ...
            echo "TOP 20 District based on $query <br />";    
...
//            }
            ...
            $sql = sprintf("select Year_ID,District_Name,Total_Revenue,Total_Local_Revenue,Total_State_Revenue,Total_Federal_Revenue from %s where Year_ID>=%s and Year_ID<=%s  order by %s desc limit 20", DB_TABLENAME,$from,$to,$query);
            $result = mysqli_query($conn,$sql);
