...
<html>
    ...
    <body>
        ...
        <div class="search">
             <form action="crime.php" method="post" id="my_form">
        <!-- year select -->
            <label class="lab" id="fyear-c">From</label>
        ...
        <button  class="btn btn-default btn-c" value="Violent_Crimes" name="query">Violent_Crimes</button>
        <button  class="btn btn-default btn-c" value="Property_Crimes" name="query">Property_Crimes</button>
        <button  class="btn btn-default btn-c" value="Murder" name="query">Murder</button>
        <button  class="btn btn-default btn-c" value="Rape" name="query">Rape</button>
        <button  class="btn btn-default btn-c" value="Robbery" name="query">Robbery</button>
        <button  class="btn btn-default btn-c" value="Assault" name="query">Assault</button>
        <button  class="btn btn-default btn-c" value="Burglary" name="query">Burglary</button>
        </div>
        </form>
        ...
        <div class="result">
            ...
            define(DB_TABLENAME, 'county_fact');
            
            $dbcolarray = array('Year_ID', 'County_Name', 'Population', 'Violent_Crimes', 'Property_Crimes', 'Murder', 'Rape', 'Robbery', 'Assault', 'Burglary');
            ...
            echo "TOP 20 County based on $query <br />";    
            ...
            $count[0] = 0;
            $sql = sprintf("select count(*) from %s where Year_ID>=%s and Year_ID<=%s", DB_TABLENAME,$from,$to,$query);
            //echo $sql;
...
//            }
            ...
            $sql = sprintf("select Year_ID,County_Name,Population,Violent_Crimes,Property_Crimes,Murder,Rape,Robbery,Assault,Burglary from %s where Year_ID>=%s and Year_ID<=%s order by %s desc limit 20", DB_TABLENAME,$from,$to,$query);
            $result = mysqli_query($conn,$sql);
