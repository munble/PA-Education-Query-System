...
<html>
    ...
    <body>
        ...
        <div class="search">
             <form action="dropout.php" method="post" id="my_form">
        <!-- county select -->
        ...
        <div class="btn-group">
        <button  class="btn btn-default" value="Enrollments" name="query">Enrollments</button>
        <button  class="btn btn-default" value="Dropouts_Total" name="query">Dropouts Total</button>
        <button  class="btn btn-default" value="Dropout_Rate" name="query">Dropout Rate</button>   
        </div>
        </form>
        ...
        <div class="result">
            ...
            define(DB_TABLENAME, 'dropout_query');
            
            $dbcolarray = array('Year_ID', 'County_Name', 'District_Name', 'Enrollments', 'Dropouts_Total', 'Dropout_Rate');
...
//            }
            ...
            $sql = sprintf("select Year_ID,County_Name,District_Name,Enrollments,Dropouts_Total,Dropout_Rate from %s where Year_ID>=%s and Year_ID<=%s  order by %s desc limit 20", DB_TABLENAME,$from,$to,$query);
            $result = mysqli_query($conn,$sql);
