...
<html>
    ...
    <body>
        ...
        <div class="search search-s">
             <form action="teacher.php" method="post" id="my_form">
        <!-- county select -->
       ...
       <!-- distrct select -->
        ...
        <div class="btn-group">
        <button  class="btn btn-default" value="Avg_Salary" name="query">Salary</button>
        <button  class="btn btn-default" value="Avg_Edu_level" name="query">Education Level</button>
        <button  class="btn btn-default" value="Avg_Edu_Exp" name="query">Education Experience</button>   
        </div>
        </form>
        ...
        <div class="result">
            ...
            echo "TOP 20 School based on teachers $query <br />";    
...
//            }
            ...
            $sql = sprintf("select distinct Year_ID,County_Name,School_Name,Avg_Salary,Avg_Edu_Level,Avg_Edu_Exp from %s where Year_ID>=%s and Year_ID<=%s  order by %s desc limit 20", DB_TABLENAME,$from,$to,$query);
            $result = mysqli_query($conn,$sql);
