...
<html>
    ...
    <body>
        ...
        <div class="search search-ex">
             <form action="expenditure.php" method="post" id="my_form">
        <!-- county select -->
        ...
        <div class="result">
            ...
            define(DB_TABLENAME, 'expenditure_query');
            
            $dbcolarray = array('Year_ID', 'District_Name', 'Total_Expenditures');
            ...
            echo "TOP 20 District based on Total_Expenditures <br />";    
            ...
            $count[0] = 0;
            $sql = sprintf("select count(*) from %s where Year_ID>=%s and Year_ID<=%s  order by Total_Expenditures desc limit 20", DB_TABLENAME,$from,$to);
...
//            }
            ...
            $sql = sprintf("select distinct Year_ID,District_Name,Total_Expenditures from %s where Year_ID>=%s and Year_ID<=%s  order by Total_Expenditures desc limit 20", DB_TABLENAME,$from,$to);
            $result = mysqli_query($conn,$sql);
