...
<html>
    ...
    <body>
        ...
        <div class="search">
             <form action="tuition.php" method="post" id="my_form">
        <!-- county select -->
        ...
        <div class="btn-group">
        <button  class="btn btn-default" value="Elementary_Tuition" name="query">Elementary Tuition</button>
        <button  class="btn btn-default" value="Secondary_Tuition" name="query">Secondary Tuition</button> 
        </div>
        </form>
        ...
        <div class="result">
            ...
            define(DB_TABLENAME, 'tuition_query');
            
            $dbcolarray = array('Year_ID', 'County_Name', 'District_Name', 'Elementary_Tuition', 'Secondary_Tuition',);
...
//            }
            ...
            $sql = sprintf("select Year_ID,County_Name,District_Name,Elementary_Tuition,Secondary_Tuition from %s where Year_ID>=%s and Year_ID<=%s  order by %s desc limit 20", DB_TABLENAME,$from,$to,$query);
